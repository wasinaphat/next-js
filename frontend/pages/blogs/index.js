...
import { listBlogsWithCategoriesAndTags } from "../../services/blog";
...
const Blogs = ({
  ...
  const head = () => {
    <Head>
      ...
      <meta
        name="description"
        content="Programming blogs  and tutorials node next vue and web development"
      />
      ...
      <meta
        ...
        content="/static/images/seoblog.jpg"
      />
